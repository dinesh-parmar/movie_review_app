...
import 'package:movie_review_app/screens/full_movie_detail.dart';
...
class MovieCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => RM.navigate.to(FullMovieDetailScreen(movieDetail: movieDetail)),
      child: SizedBox(
        height: 250,
